namespace System.Collections.Generic
{
    ...
    [Serializable, DebuggerDisplay("Count = {Count}"), DebuggerTypeProxy(typeof(HashSetDebugView<>)), HostProtection(SecurityAction.LinkDemand, MayLeakOnAbort=true)]
    public class HashSet<T> : ISerializable, IDeserializationCallback, ISet<T>, ICollection<T>, IEnumerable<T>, IEnumerable
    {
        ...
        public HashSet(IEnumerable<T> collection, IEqualityComparer<T> comparer) : this(comparer)
        {
            ...
            if (((this.m_count == 0) && (this.m_slots.Length > System.Collections.Generic.HashHelpers.GetMinPrime())) || ((this.m_count > 0) && ((this.m_slots.Length / this.m_count) > 3)))
            {
                this.TrimExcess();
            }
        }
        ...
        private void IncreaseCapacity()
        {
            ...
            int prime = System.Collections.Generic.HashHelpers.GetPrime(min);
        ...
        {
            int prime = System.Collections.Generic.HashHelpers.GetPrime(capacity);
        ...
        public void TrimExcess()
        {
            ...
            {
                int prime = System.Collections.Generic.HashHelpers.GetPrime(this.m_count);
