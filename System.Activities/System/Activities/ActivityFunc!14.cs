namespace System.Activities
{
    ...
    public sealed class ActivityFunc<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult> : ActivityDelegate
    {
        ...
        {
            return new List<RuntimeDelegateArgument>(14) { new RuntimeDelegateArgument(ActivityDelegate.Argument1Name, typeof(T1), 0, this.Argument1), new RuntimeDelegateArgument(ActivityDelegate.Argument2Name, typeof(T2), 0, this.Argument2), new RuntimeDelegateArgument(ActivityDelegate.Argument3Name, typeof(T3), 0, this.Argument3), new RuntimeDelegateArgument(ActivityDelegate.Argument4Name, typeof(T4), 0, this.Argument4), new RuntimeDelegateArgument(ActivityDelegate.Argument5Name, typeof(T5), 0, this.Argument5), new RuntimeDelegateArgument(ActivityDelegate.Argument6Name, typeof(T6), 0, this.Argument6), new RuntimeDelegateArgument(ActivityDelegate.Argument7Name, typeof(T7), 0, this.Argument7), new RuntimeDelegateArgument(ActivityDelegate.Argument8Name, typeof(T8), 0, this.Argument8), new RuntimeDelegateArgument(ActivityDelegate.Argument9Name, typeof(T9), 0, this.Argument9), new RuntimeDelegateArgument(ActivityDelegate.Argument10Name, typeof(T10), 0, this.Argument10), new RuntimeDelegateArgument(ActivityDelegate.Argument11Name, typeof(T11), 0, this.Argument11), new RuntimeDelegateArgument(ActivityDelegate.Argument12Name, typeof(T12), 0, this.Argument12), new RuntimeDelegateArgument(ActivityDelegate.Argument13Name, typeof(T13), 0, this.Argument13), new RuntimeDelegateArgument(ActivityDelegate.ResultArgumentName, typeof(TResult), 1, this.Result) };
        }
