namespace System.Activities.Statements
{
    ...
    public sealed class InvokeAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : NativeActivity
    {
        protected override void Execute(NativeActivityContext context)
        {
            ...
            {
                context.ScheduleAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(this.Action, this.Argument1.Get(context), this.Argument2.Get(context), this.Argument3.Get(context), this.Argument4.Get(context), this.Argument5.Get(context), this.Argument6.Get(context), this.Argument7.Get(context), this.Argument8.Get(context), this.Argument9.Get(context), this.Argument10.Get(context), this.Argument11.Get(context), this.Argument12.Get(context), this.Argument13.Get(context), null, null);
            }
        }
