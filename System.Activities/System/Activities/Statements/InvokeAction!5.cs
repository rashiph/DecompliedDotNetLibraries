namespace System.Activities.Statements
{
    ...
    public sealed class InvokeAction<T1, T2, T3, T4, T5> : NativeActivity
    {
        protected override void Execute(NativeActivityContext context)
        {
            ...
            {
                context.ScheduleAction<T1, T2, T3, T4, T5>(this.Action, this.Argument1.Get(context), this.Argument2.Get(context), this.Argument3.Get(context), this.Argument4.Get(context), this.Argument5.Get(context), null, null);
            }
        }
