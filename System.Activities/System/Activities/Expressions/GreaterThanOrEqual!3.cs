namespace System.Activities.Expressions
{
    ...
    public sealed class GreaterThanOrEqual<TLeft, TRight, TResult> : CodeActivity<TResult>
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            if ((GreaterThanOrEqual<TLeft, TRight, TResult>.operationFunction == null) && !BinaryExpressionHelper.TryGenerateLinqDelegate<TLeft, TRight, TResult>(ExpressionType.GreaterThanOrEqual, out GreaterThanOrEqual<TLeft, TRight, TResult>.operationFunction, out error))
            {
        ...
        protected override TResult Execute(CodeActivityContext context)
        {
            ...
            return GreaterThanOrEqual<TLeft, TRight, TResult>.operationFunction(local, local2);
        }
