namespace System.Activities.Expressions
{
    ...
    public sealed class NotEqual<TLeft, TRight, TResult> : CodeActivity<TResult>
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            if ((NotEqual<TLeft, TRight, TResult>.operationFunction == null) && !BinaryExpressionHelper.TryGenerateLinqDelegate<TLeft, TRight, TResult>(ExpressionType.NotEqual, out NotEqual<TLeft, TRight, TResult>.operationFunction, out error))
            {
        ...
        protected override TResult Execute(CodeActivityContext context)
        {
            ...
            return NotEqual<TLeft, TRight, TResult>.operationFunction(local, local2);
        }
