namespace System.Activities.Expressions
{
    ...
    public sealed class And<TLeft, TRight, TResult> : CodeActivity<TResult>
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            if ((And<TLeft, TRight, TResult>.operationFunction == null) && !BinaryExpressionHelper.TryGenerateLinqDelegate<TLeft, TRight, TResult>(ExpressionType.And, out And<TLeft, TRight, TResult>.operationFunction, out error))
            {
        ...
        protected override TResult Execute(CodeActivityContext context)
        {
            ...
            return And<TLeft, TRight, TResult>.operationFunction(local, local2);
        }
