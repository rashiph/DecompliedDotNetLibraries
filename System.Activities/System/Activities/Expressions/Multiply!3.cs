namespace System.Activities.Expressions
{
    ...
    public sealed class Multiply<TLeft, TRight, TResult> : CodeActivity<TResult>
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            {
                this.EnsureOperationFunction(metadata, ref Multiply<TLeft, TRight, TResult>.checkedOperationFunction, ExpressionType.MultiplyChecked);
            }
            else
            {
                this.EnsureOperationFunction(metadata, ref Multiply<TLeft, TRight, TResult>.uncheckedOperationFunction, ExpressionType.Multiply);
            }
        }
        ...
        protected override TResult Execute(CodeActivityContext context)
        {
            ...
            if (this.checkedOperation)
            {
                return Multiply<TLeft, TRight, TResult>.checkedOperationFunction(local, local2);
            }
            return Multiply<TLeft, TRight, TResult>.uncheckedOperationFunction(local, local2);
        }
