namespace System.Activities.Expressions
{
    ...
    public sealed class Divide<TLeft, TRight, TResult> : CodeActivity<TResult>
    {
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            if ((Divide<TLeft, TRight, TResult>.operationFunction == null) && !BinaryExpressionHelper.TryGenerateLinqDelegate<TLeft, TRight, TResult>(ExpressionType.Divide, out Divide<TLeft, TRight, TResult>.operationFunction, out error))
            {
        ...
        protected override TResult Execute(CodeActivityContext context)
        {
            ...
            return Divide<TLeft, TRight, TResult>.operationFunction(local, local2);
        }
