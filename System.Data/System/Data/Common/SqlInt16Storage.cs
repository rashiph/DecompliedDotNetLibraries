    ...
    internal sealed class SqlInt16Storage : DataStorage
    {
        ...
        public override object Aggregate(int[] records, AggregateType kind)
        {
            ...
            try
            {
                ...
                switch (kind)
                {
                    ...
                    case AggregateType.Min:
                        maxValue = SqlInt16.MaxValue;
                        num6 = 0;
                        goto Label_0313;

                    case AggregateType.Max:
                        minValue = SqlInt16.MinValue;
                        num5 = 0;
                        goto Label_0392;
            ...
            Label_02C3:
                ...
                {
                    if (SqlInt16.LessThan(this.values[num13], maxValue).IsTrue)
                    {
            ...
            Label_0342:
                ...
                {
                    if (SqlInt16.GreaterThan(this.values[num11], minValue).IsTrue)
                    {
        ...
        {
            SqlInt16[] numArray = (SqlInt16[]) store;
