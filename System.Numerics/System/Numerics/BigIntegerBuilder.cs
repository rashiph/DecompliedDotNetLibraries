namespace System.Numerics
{
    ...
    internal struct BigIntegerBuilder
    {
        ...
        private static readonly double kdblLn2To32;
        private static readonly byte[] _rgbInv;
        [Conditional("DEBUG")]
        private void AssertValid(bool fTrimmed)
        {
            int num1 = this._iuLast;
        }
        ...
        private void SetSizeKeep(int cu, int cuExtra)
        {
            ...
            else
            {
                if (!this._fWritable || (this._rgu.Length < cu))
                {
                    ...
                    {
                        Array.Copy(this._rgu, destinationArray, Math.Min(cu, this._iuLast + 1));
                    }
        ...
        public void EnsureWritable(int cu, int cuExtra)
        {
            if (!this._fWritable || (this._rgu.Length < cu))
            {
                ...
                if (this._iuLast > 0)
                {
                    ...
                    Array.Copy(this._rgu, destinationArray, (int) (this._iuLast + 1));
                }
                this._rgu = destinationArray;
                this._fWritable = true;
            }
        ...
        public void Load(ref BigIntegerBuilder reg, int cuExtra)
        {
            ...
            else
            {
                ...
                Array.Copy(reg._rgu, this._rgu, (int) (this._iuLast + 1));
            }
        }
        ...
        public void Mul(ref BigIntegerBuilder reg1, ref BigIntegerBuilder reg2)
        {
            if (reg1._iuLast == 0)
            {
                if (reg2._iuLast == 0)
                {
                    this.Set((ulong) (reg1._uSmall * reg2._uSmall));
                }
                else
                {
        ...
        Label_0159:
            ...
            ulong num14 = num7 + (num11 * num9);
            ulong num15 = num8 + (num11 * num10);
            if (((num14 <= 0x7fffffffL) && (num15 <= 0x7fffffffL)) && ((num12 >= num15) && ((num12 + num14) <= (num5 - num9))))
            {
                ...
                if (a > num8)
                {
                    ...
                    num14 = num10 + (num11 * num8);
                    num15 = num9 + (num11 * num7);
        ...
        Label_029E:
            ...
            else
            {
                ...
                for (int i = 0; i < b; i++)
                {
                    ...
                    long num22 = ((num20 * num7) - (num21 * num8)) + num17;
                    long num23 = ((num21 * num10) - (num20 * num9)) + num18;
        ...
        {
            kdblLn2To32 = 32.0 * Math.Log(2.0);
            _rgbInv = new byte[] { 
                1, 0xab, 0xcd, 0xb7, 0x39, 0xa3, 0xc5, 0xef, 0xf1, 0x1b, 0x3d, 0xa7, 0x29, 0x13, 0x35, 0xdf, 
                0xe1, 0x8b, 0xad, 0x97, 0x19, 0x83, 0xa5, 0xcf, 0xd1, 0xfb, 0x1d, 0x87, 9, 0xf3, 0x15, 0xbf, 
                ...
                0x61, 11, 0x2d, 0x17, 0x99, 3, 0x25, 0x4f, 0x51, 0x7b, 0x9d, 7, 0x89, 0x73, 0x95, 0x3f, 
                0x41, 0xeb, 13, 0xf7, 0x79, 0xe3, 5, 0x2f, 0x31, 0x5b, 0x7d, 0xe7, 0x69, 0x53, 0x75, 0x1f, 
                0x21, 0xcb, 0xed, 0xd7, 0x59, 0xc3, 0xe5, 15, 0x11, 0x3b, 0x5d, 0xc7, 0x49, 0x33, 0x55, 0xff
             };
        }
    }
}
