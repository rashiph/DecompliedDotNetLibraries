    ...
    public struct BigInteger : IFormattable, IComparable, IComparable<BigInteger>, IEquatable<BigInteger>
    {
        ...
        public BigInteger(byte[] value)
        {
            ...
            else if (length <= 4)
            {
                ...
                {
                    this._bits = new uint[] { this._sign };
                    this._sign = 1;
                }
        ...
        public static BigInteger operator >>(BigInteger value, int shift)
        {
            ...
            if (negative)
            {
                ...
                Array.Copy(numArray, destinationArray, num3);
        ...
        private uint[] ToUInt32Array()
        {
            ...
            Array.Copy(numArray, destinationArray, (int) (index + 1));
            if (flag)
            {
        ...
        private BigInteger(uint[] value)
        {
            ...
            else
            {
                ...
                else if (num2 != value.Length)
                {
                    ...
                    Array.Copy(value, this._bits, num2);
                }
                else
                {
                    this._sign = -1;
