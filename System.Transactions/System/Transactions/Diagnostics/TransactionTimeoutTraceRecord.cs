    ...
    internal class TransactionTimeoutTraceRecord : TraceRecord
    {
        ...
        internal static void Trace(string traceSource, TransactionTraceIdentifier txTraceId)
        {
            lock (record)
            {
                ...
                DiagnosticTrace.TraceEvent(TraceEventType.Warning, "http://msdn.microsoft.com/2004/06/System/Transactions/TransactionTimeout", System.Transactions.SR.GetString("TraceTransactionTimeout"), record);
            }
        }
