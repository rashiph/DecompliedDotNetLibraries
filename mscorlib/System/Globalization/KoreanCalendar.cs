namespace System.Globalization
{
    ...
    {
        private const int DEFAULT_TWO_DIGIT_YEAR_MAX = 0x110a;
        internal GregorianCalendarHelper helper;
        public const int KoreanEra = 1;
        internal static EraInfo[] koreanEraInfo = InitEraInfo();
        ...
        public KoreanCalendar()
        {
            ...
            this.helper = new GregorianCalendarHelper(this, koreanEraInfo);
        }
        ...
        {
            return new EraInfo[] { new EraInfo(1, 1, 1, 1, -2333, 0x91e, 0x302c) };
        }
        ...
        public override int TwoDigitYearMax
        {
            get
            {
                ...
                {
                    base.twoDigitYearMax = Calendar.GetSystemTwoDigitYearSetting(this.ID, 0x110a);
                }
