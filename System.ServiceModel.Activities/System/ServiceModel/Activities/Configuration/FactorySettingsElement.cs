namespace System.ServiceModel.Activities.Configuration
{
    ...
    public sealed class FactorySettingsElement : ConfigurationElement
    {
        ...
        [ServiceModelTimeSpanValidator(MinValueString="00:00:00"), ConfigurationProperty("leaseTimeout", DefaultValue="Infinite"), TypeConverter(typeof(TimeSpanOrInfiniteConverter))]
        ...
        protected override ConfigurationPropertyCollection Properties
        {
            get
            {
                if (this.properties == null)
                {
                    ...
                    propertys.Add(new ConfigurationProperty("leaseTimeout", typeof(TimeSpan), "00:05:00", new TimeSpanOrInfiniteConverter(), new TimeSpanOrInfiniteValidator(TimeSpan.Parse("00:00:00", CultureInfo.InvariantCulture), TimeSpan.Parse("24.20:31:23.6470000", CultureInfo.InvariantCulture)), ConfigurationPropertyOptions.None));
