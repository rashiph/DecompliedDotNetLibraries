namespace System.Configuration
{
    ...
    internal sealed class SR
    {
        ...
        private static System.Configuration.SR loader;
        ...
        private static System.Configuration.SR GetLoader()
        {
            if (loader == null)
            {
                System.Configuration.SR sr = new System.Configuration.SR();
                Interlocked.CompareExchange<System.Configuration.SR>(ref loader, sr, null);
            }
            return loader;
        }
        ...
        {
            System.Configuration.SR loader = GetLoader();
            if (loader == null)
            {
                return null;
            }
