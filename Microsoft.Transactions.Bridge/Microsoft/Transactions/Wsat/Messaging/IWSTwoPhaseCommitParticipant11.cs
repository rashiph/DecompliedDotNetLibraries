namespace Microsoft.Transactions.Wsat.Messaging
{
    ...
    [ServiceContract(Name="ParticipantPortType", Namespace="http://docs.oasis-open.org/ws-tx/wsat/2006/06")]
    internal interface IWSTwoPhaseCommitParticipant11 : IWSTwoPhaseCommitParticipant
    {
        [OperationContract(Action="http://docs.oasis-open.org/ws-tx/wsat/2006/06/Commit", IsOneWay=true)]
        void Commit(Message message);
        [OperationContract(Action="http://docs.oasis-open.org/ws-tx/wsat/2006/06/Prepare", IsOneWay=true)]
