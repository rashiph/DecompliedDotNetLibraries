namespace System.Security.Cryptography
{
    ...
    internal static class CAPI
    {
        ...
        internal const uint CRYPTPROTECT_CRED_SYNC = 8;
        internal const uint CRYPTPROTECT_LOCAL_MACHINE = 4;
        internal const uint CRYPTPROTECT_NO_RECOVERY = 0x20;
        internal const uint CRYPTPROTECT_UI_FORBIDDEN = 1;
        ...
        [SecurityCritical]
        internal static System.Security.Cryptography.SafeCertContextHandle CryptUIDlgSelectCertificateW([In, Out, MarshalAs(UnmanagedType.LPStruct)] CRYPTUI_SELECTCERTIFICATE_STRUCTW csc)
        {
        ...
        {
            System.Security.Cryptography.SafeLocalAllocHandle handle = CAPISafe.LocalAlloc(uFlags, sizetdwBytes);
        ...
        internal static class CAPISafe
        {
            ...
            internal static extern IntPtr GetProcAddress([In] System.Security.Cryptography.SafeLibraryHandle hModule, [In, MarshalAs(UnmanagedType.LPStr)] string lpProcName);
            [DllImport("kernel32.dll", EntryPoint="LoadLibraryA", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern System.Security.Cryptography.SafeLibraryHandle LoadLibrary([In, MarshalAs(UnmanagedType.LPStr)] string lpFileName);
            [DllImport("kernel32.dll", CharSet=CharSet.Auto, SetLastError=true)]
        ...
        {
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern bool CertAddCertificateContextToStore([In] System.Security.Cryptography.SafeCertStoreHandle hCertStore, [In] System.Security.Cryptography.SafeCertContextHandle pCertContext, [In] uint dwAddDisposition, [In, Out] System.Security.Cryptography.SafeCertContextHandle ppStoreContext);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern bool CertAddCertificateLinkToStore([In] System.Security.Cryptography.SafeCertStoreHandle hCertStore, [In] System.Security.Cryptography.SafeCertContextHandle pCertContext, [In] uint dwAddDisposition, [In, Out] System.Security.Cryptography.SafeCertContextHandle ppStoreContext);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern System.Security.Cryptography.SafeCertContextHandle CertCreateSelfSignCertificate([In] System.Security.Cryptography.SafeCryptProvHandle hProv, [In] IntPtr pSubjectIssuerBlob, [In] uint dwFlags, [In] IntPtr pKeyProvInfo, [In] IntPtr pSignatureAlgorithm, [In] IntPtr pStartTime, [In] IntPtr pEndTime, [In] IntPtr pExtensions);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern IntPtr CertEnumCertificatesInStore([In] System.Security.Cryptography.SafeCertStoreHandle hCertStore, [In] IntPtr pPrevCertContext);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern System.Security.Cryptography.SafeCertContextHandle CertFindCertificateInStore([In] System.Security.Cryptography.SafeCertStoreHandle hCertStore, [In] uint dwCertEncodingType, [In] uint dwFindFlags, [In] uint dwFindType, [In] IntPtr pvFindPara, [In] System.Security.Cryptography.SafeCertContextHandle pPrevCertContext);
            [DllImport("crypt32.dll", CharSet=CharSet.Unicode, SetLastError=true)]
            internal static extern System.Security.Cryptography.SafeCertStoreHandle CertOpenStore([In] IntPtr lpszStoreProvider, [In] uint dwMsgAndCertEncodingType, [In] IntPtr hCryptProv, [In] uint dwFlags, [In] string pvPara);
            [DllImport("advapi32.dll", EntryPoint="CryptAcquireContextA", CharSet=CharSet.Auto)]
            internal static extern bool CryptAcquireContext([In, Out] ref System.Security.Cryptography.SafeCryptProvHandle hCryptProv, [In, MarshalAs(UnmanagedType.LPStr)] string pszContainer, [In, MarshalAs(UnmanagedType.LPStr)] string pszProvider, [In] uint dwProvType, [In] uint dwFlags);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern bool CryptMsgControl([In] System.Security.Cryptography.SafeCryptMsgHandle hCryptMsg, [In] uint dwFlags, [In] uint dwCtrlType, [In] IntPtr pvCtrlPara);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern bool CryptMsgCountersign([In] System.Security.Cryptography.SafeCryptMsgHandle hCryptMsg, [In] uint dwIndex, [In] uint cCountersigners, [In] IntPtr rgCountersigners);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern System.Security.Cryptography.SafeCryptMsgHandle CryptMsgOpenToEncode([In] uint dwMsgEncodingType, [In] uint dwFlags, [In] uint dwMsgType, [In] IntPtr pvMsgEncodeInfo, [In] IntPtr pszInnerContentObjID, [In] IntPtr pStreamInfo);
            [DllImport("crypt32.dll", CharSet=CharSet.Auto, SetLastError=true)]
            internal static extern System.Security.Cryptography.SafeCryptMsgHandle CryptMsgOpenToEncode([In] uint dwMsgEncodingType, [In] uint dwFlags, [In] uint dwMsgType, [In] IntPtr pvMsgEncodeInfo, [In, MarshalAs(UnmanagedType.LPStr)] string pszInnerContentObjID, [In] IntPtr pStreamInfo);
            [DllImport("crypt32.dll", CharSet=CharSet.Unicode, SetLastError=true)]
            ...
            internal static extern System.Security.Cryptography.SafeCertContextHandle CryptUIDlgSelectCertificateW([In, Out, MarshalAs(UnmanagedType.LPStruct)] System.Security.Cryptography.CAPI.CRYPTUI_SELECTCERTIFICATE_STRUCTW csc);
            [DllImport("cryptui.dll", CharSet=CharSet.Unicode, SetLastError=true)]
            internal static extern bool CryptUIDlgViewCertificateW([In, MarshalAs(UnmanagedType.LPStruct)] System.Security.Cryptography.CAPI.CRYPTUI_VIEWCERTIFICATE_STRUCTW ViewInfo, [In, Out] IntPtr pfPropertiesChanged);
            [DllImport("crypt32.dll", CharSet=CharSet.Unicode, SetLastError=true)]
        ...
        {
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB SubjectType;
        ...
        internal struct CERT_CHAIN_PARA
        {
            ...
            internal System.Security.Cryptography.CAPI.CERT_USAGE_MATCH RequestedUsage;
            internal System.Security.Cryptography.CAPI.CERT_USAGE_MATCH RequestedIssuancePolicy;
        ...
        {
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB p;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB q;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB g;
        }
        ...
        internal struct CERT_EXTENSION
        {
            ...
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB Value;
        }
        ...
        internal struct CERT_ID
        {
            ...
            internal System.Security.Cryptography.CAPI.CERT_ID_UNION Value;
        }
        ...
        {
            [FieldOffset(0)]
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB HashId;
            [FieldOffset(0)]
            internal System.Security.Cryptography.CAPI.CERT_ISSUER_SERIAL_NUMBER IssuerSerialNumber;
            [FieldOffset(0)]
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB KeyId;
        }
        ...
        internal struct CERT_INFO
        {
            ...
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB SerialNumber;
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER SignatureAlgorithm;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB Issuer;
            ...
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB Subject;
            internal System.Security.Cryptography.CAPI.CERT_PUBLIC_KEY_INFO SubjectPublicKeyInfo;
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB IssuerUniqueId;
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB SubjectUniqueId;
        ...
        internal struct CERT_KEY_USAGE_RESTRICTION_INFO
        {
            ...
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB RestrictedKeyUsage;
        }
        ...
        internal struct CERT_POLICY_QUALIFIER_INFO
        {
            ...
            private System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB Qualifier;
        }

        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Unicode)]
        internal struct CERT_PUBLIC_KEY_INFO
        {
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER Algorithm;
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB PublicKey;
        }

        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Unicode)]
        internal struct CERT_PUBLIC_KEY_INFO2
        {
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER2 Algorithm;
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB PublicKey;
        }
        ...
        internal struct CERT_USAGE_MATCH
        {
            ...
            internal System.Security.Cryptography.CAPI.CERT_ENHKEY_USAGE Usage;
        }
        ...
        {
            internal uint dwVersion;
            internal System.Security.Cryptography.CAPI.CERT_ID SignerId;
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER HashAlgorithm;
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER HashEncryptionAlgorithm;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB EncryptedHash;
            internal System.Security.Cryptography.CAPI.CRYPT_ATTRIBUTES AuthAttrs;
            internal System.Security.Cryptography.CAPI.CRYPT_ATTRIBUTES UnauthAttrs;
        }
        ...
        internal struct CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA
        {
            ...
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB blob;
        ...
        internal struct CMSG_CTRL_KEY_AGREE_DECRYPT_PARA
        {
            ...
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB OriginatorPublicKey;
            internal CMSG_CTRL_KEY_AGREE_DECRYPT_PARA(int size)
            {
                ...
                this.OriginatorPublicKey = new System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB();
            }
        }
        ...
        internal struct CMSG_CTRL_KEY_TRANS_DECRYPT_PARA
        {
            internal uint cbSize;
            [SecurityCritical]
            internal System.Security.Cryptography.SafeCryptProvHandle hCryptProv;
            internal uint dwKeySpec;
        ...
        internal struct CMSG_ENVELOPED_ENCODE_INFO
        {
            internal uint cbSize;
            internal IntPtr hCryptProv;
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER ContentEncryptionAlgorithm;
        ...
        internal struct CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO
        {
            ...
            internal System.Security.Cryptography.CAPI.CERT_ID OriginatorCertId;
            internal IntPtr Padding;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB UserKeyingMaterial;
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER KeyEncryptionAlgorithm;
        ...
        internal struct CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO
        {
            internal uint dwVersion;
            internal uint dwOriginatorChoice;
            internal System.Security.Cryptography.CAPI.CERT_PUBLIC_KEY_INFO OriginatorPublicKeyInfo;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB UserKeyingMaterial;
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER KeyEncryptionAlgorithm;
            internal uint cRecipientEncryptedKeys;
            internal IntPtr rgpRecipientEncryptedKeys;
        ...
        internal struct CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO
        {
            ...
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER KeyWrapAlgorithm;
        ...
        internal struct CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO
        {
            ...
            internal IntPtr pvKeyEncryptionAuxInfo;
            internal IntPtr hCryptProv;
            internal System.Security.Cryptography.CAPI.CRYPT_BIT_BLOB RecipientPublicKey;
        ...
        internal struct CMSG_KEY_TRANS_RECIPIENT_INFO
        {
            ...
            internal System.Security.Cryptography.CAPI.CERT_ID RecipientId;
            internal System.Security.Cryptography.CAPI.CRYPT_ALGORITHM_IDENTIFIER KeyEncryptionAlgorithm;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB EncryptedKey;
        }
        ...
        internal class CMSG_STREAM_INFO
        {
            ...
            internal System.Security.Cryptography.CAPI.PFN_CMSG_STREAM_OUTPUT pfnStreamOutput;
            internal IntPtr pvArg;
            internal CMSG_STREAM_INFO(uint cbContent, System.Security.Cryptography.CAPI.PFN_CMSG_STREAM_OUTPUT pfnStreamOutput, IntPtr pvArg)
            {
        ...
        internal struct CRYPT_ALGORITHM_IDENTIFIER
        {
            [MarshalAs(UnmanagedType.LPStr)]
            internal string pszObjId;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB Parameters;
        }
        ...
        internal struct CRYPT_OID_INFO
        {
            ...
            internal uint Algid;
            internal System.Security.Cryptography.CAPI.CRYPTOAPI_BLOB ExtraInfo;
