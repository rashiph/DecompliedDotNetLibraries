namespace System.Data.OracleClient
{
    ...
    internal sealed class DBConnectionString
    {
        ...
        private readonly System.Data.OracleClient.NameValuePair _keychain;
        ...
        internal DBConnectionString(string value, string restrictions, KeyRestrictionBehavior behavior, Hashtable synonyms, bool useOdbcRules) : this(new System.Data.Common.DbConnectionOptions(value, synonyms, useOdbcRules), restrictions, behavior, synonyms, false)
        {
        }
        ...
        internal System.Data.OracleClient.DBConnectionString Intersect(System.Data.OracleClient.DBConnectionString entry)
        {
            ...
            else if (this._behavior != entry._behavior)
            {
                ...
                {
                    if (!System.Data.Common.ADP.IsEmptyArray(this._restrictionValues))
                    {
                ...
                else if (!System.Data.Common.ADP.IsEmptyArray(this._restrictionValues))
                {
                    if (!System.Data.Common.ADP.IsEmptyArray(entry._restrictionValues))
                    {
            ...
            else if (KeyRestrictionBehavior.PreventUsage == this._behavior)
            {
                ...
                else if (System.Data.Common.ADP.IsEmptyArray(entry._restrictionValues))
                {
                    restrictionValues = this._restrictionValues;
                }
                else
            ...
            else if (!System.Data.Common.ADP.IsEmptyArray(this._restrictionValues) && !System.Data.Common.ADP.IsEmptyArray(entry._restrictionValues))
            {
            ...
            return new System.Data.OracleClient.DBConnectionString(this, restrictionValues, allowOnly);
        }
        ...
        private static string[] ParseRestrictions(string restrictions, Hashtable synonyms)
        {
            ...
            while (num < length)
            {
                ...
                num = System.Data.Common.DbConnectionOptions.GetKeyValuePair(restrictions, currentPosition, buffer, false, out str, out str3);
                if (!System.Data.Common.ADP.IsEmpty(str))
                {
                    ...
                    {
                        throw System.Data.Common.ADP.KeywordNotSupported(str);
                    }
                    list.Add(str2);
                }
            }
        ...
        internal System.Data.OracleClient.NameValuePair KeyChain
        {
            get
            {
            ...
            get
            {
                ...
                if (str == null)
                {
                    ...
                    if ((strArray != null) && (0 < strArray.Length))
                    {
                        ...
                        {
                            if (!System.Data.Common.ADP.IsEmpty(strArray[i]))
                            {
