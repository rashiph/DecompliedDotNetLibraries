    ...
    internal static class DiagnosticUtility
    {
        ...
        private static System.ServiceModel.Diagnostics.ExceptionUtility GetExceptionUtility()
        {
            lock (lockObject)
            {
                ...
                {
                    exceptionUtility = new System.ServiceModel.Diagnostics.ExceptionUtility("System.IdentityModel", "System.IdentityModel 4.0.0.0", diagnosticTrace);
                }
            }
        ...
        {
            diagnosticTrace = new System.ServiceModel.Diagnostics.DiagnosticTrace(sourceType, traceSourceName, "System.IdentityModel 4.0.0.0");
            UpdateLevel();
        }

        private static System.ServiceModel.Diagnostics.DiagnosticTrace InitializeTracing()
        {
            InitDiagnosticTraceImpl(TraceSourceKind.PiiTraceSource, "System.IdentityModel");
