namespace System.Xaml.Hosting
{
    ...
    {
        private const string baseEventSourceName = "System.Xaml.Hosting";
        ...
        private static DiagnosticTrace InitializeTracing()
        {
            ...
            DiagnosticTrace trace = new DiagnosticTrace("System.Xaml.Hosting", etwProviderId);
        ...
        private static string EventSourceName
        {
            get
            {
                ...
                {
                    eventSourceName = "System.Xaml.Hosting" + " " + "4.0.0.0";
                }
