namespace System.Web.Util
{
    ...
    internal static class StringUtil
    {
        ...
        internal static string CheckAndTrimString(string paramValue, string paramName, bool throwIfNull, int lengthToCheck)
        {
            ...
            if (str.Length == 0)
            {
                throw new ArgumentException(System.Web.SR.GetString("PersonalizationProviderHelper_TrimmedEmptyString", new object[] { paramName }));
            }
            if ((lengthToCheck > -1) && (str.Length > lengthToCheck))
            {
                throw new ArgumentException(System.Web.SR.GetString("StringUtil_Trimmed_String_Exceed_Maximum_Length", new object[] { paramValue, paramName, lengthToCheck.ToString(CultureInfo.InvariantCulture) }));
            }
            return str;
        }
        ...
        internal static unsafe bool Equals(string s1, int offset1, string s2, int offset2, int length)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(System.Web.SR.GetString("InvalidOffsetOrCount", new object[] { "offset1", "length" }));
            }
            if ((((s2 == null) ? 0 : s2.Length) - offset2) < length)
            {
                throw new ArgumentOutOfRangeException(System.Web.SR.GetString("InvalidOffsetOrCount", new object[] { "offset2", "length" }));
            }
            if (!string.IsNullOrEmpty(s1) && !string.IsNullOrEmpty(s2))
            {
                fixed (char* str = ((char*) s1))
                {
                    ...
                    {
                        char* chPtr2 = str2;
                        char* chPtr3 = chPtr + offset1;
                        char* chPtr4 = chPtr2 + offset2;
                        int num = length;
                        while (num-- > 0)
                        {
                            chPtr3++;
