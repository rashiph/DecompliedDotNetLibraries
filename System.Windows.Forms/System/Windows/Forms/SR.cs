namespace System.Windows.Forms
{
    ...
    internal sealed class SR
    {
        ...
        private static System.Windows.Forms.SR loader;
        ...
        private static System.Windows.Forms.SR GetLoader()
        {
            if (loader == null)
            {
                System.Windows.Forms.SR sr = new System.Windows.Forms.SR();
                Interlocked.CompareExchange<System.Windows.Forms.SR>(ref loader, sr, null);
            }
            return loader;
        }
        ...
        {
            System.Windows.Forms.SR loader = GetLoader();
            if (loader == null)
            {
                return null;
            }
