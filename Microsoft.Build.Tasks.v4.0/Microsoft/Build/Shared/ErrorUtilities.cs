namespace Microsoft.Build.Shared
{
    ...
    internal static class ErrorUtilities
    {
        ...
        internal static void VerifyThrowArgumentArraysSameLength(Array parameter1, Array parameter2, string parameter1Name, string parameter2Name)
        {
            ...
            {
                throw new ArgumentException(Microsoft.Build.Shared.ResourceUtilities.FormatResourceString("Shared.ParametersMustHaveTheSameLength", new object[] { parameter1Name, parameter2Name }));
            }
        }
        ...
        internal static void VerifyThrowArgumentLength(string parameter, string parameterName)
        {
            ...
            {
                throw new ArgumentException(Microsoft.Build.Shared.ResourceUtilities.FormatResourceString("Shared.ParameterCannotHaveZeroLength", new object[] { parameterName }));
            }
        }
        ...
        internal static void VerifyThrowArgumentNull(object parameter, string parameterName, string resourceName)
        {
            ...
            {
                throw new ArgumentNullException(Microsoft.Build.Shared.ResourceUtilities.FormatResourceString(resourceName, new object[] { parameterName }), null);
            }
        }
