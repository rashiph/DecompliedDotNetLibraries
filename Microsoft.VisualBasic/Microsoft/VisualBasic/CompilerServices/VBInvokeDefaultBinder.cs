namespace Microsoft.VisualBasic.CompilerServices
{
    ...
    internal class VBInvokeDefaultBinder : InvokeBinder
    {
        private static readonly int _hash = typeof(VBInvokeDefaultBinder).GetHashCode();
        private readonly bool _reportErrors;

        public VBInvokeDefaultBinder(CallInfo CallInfo, bool ReportErrors) : base(CallInfo)
        {
        ...
        {
            VBInvokeDefaultBinder binder = _other as VBInvokeDefaultBinder;
        ...
        public override DynamicMetaObject FallbackInvoke(DynamicMetaObject target, DynamicMetaObject[] packedArgs, DynamicMetaObject errorSuggestion)
        {
            ...
            Expression right = Expression.Call(typeof(NewLateBinding).GetMethod("FallbackInvokeDefault1"), target.Expression, Expression.Assign(expression, Expression.NewArrayInit(typeof(object), args)), Expression.Constant(argNames, typeof(string[])), Expression.Constant(this._reportErrors));
