        ...
        protected override ConfigurationPropertyCollection Properties
        {
            get
            {
                if (this.properties == null)
                {
                    ...
                    propertys.Add(new ConfigurationProperty("clientCredentialType", typeof(HttpClientCredentialType), HttpClientCredentialType.None, null, new ServiceModelEnumValidator(typeof(HttpClientCredentialTypeHelper)), ConfigurationPropertyOptions.None));
