namespace Microsoft.JScript
{
    ...
    internal sealed class Logical_or : BinaryOp
    {
        ...
        internal override void TranslateToConditionalBranch(ILGenerator il, bool branchIfTrue, Label label, bool shortForm)
        {
            ...
            if (branchIfTrue)
            {
                base.operand1.TranslateToConditionalBranch(il, true, label, shortForm);
                base.operand2.TranslateToConditionalBranch(il, true, label, shortForm);
            }
            else
            {
                base.operand1.TranslateToConditionalBranch(il, true, label2, shortForm);
        ...
        internal override void TranslateToIL(ILGenerator il, Type rtype)
        {
            ...
            MethodInfo meth = type.GetMethod("op_True", BindingFlags.ExactBinding | BindingFlags.Public | BindingFlags.Static, null, new Type[] { type }, null);
            ...
            if (meth != null)
            {
                info2 = type.GetMethod("op_BitwiseOr", BindingFlags.ExactBinding | BindingFlags.Public | BindingFlags.Static, null, new Type[] { type, type }, null);
            }
            if ((info2 == null) || ((info2.Attributes & MethodAttributes.SpecialName) == MethodAttributes.PrivateScope))
            {
                meth = null;
