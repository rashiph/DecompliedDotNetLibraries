namespace System.Workflow.ComponentModel.Design
{
    ...
    internal static class Helpers
    {
        ...
        internal static string GetDesignTimeTypeName(object owner, object key)
        {
            ...
            if (((obj2 != null) && (key != null)) && obj2.UserData.Contains(UserDataKeys.DesignTimeTypeNames))
            {
                Hashtable hashtable = obj2.UserData[UserDataKeys.DesignTimeTypeNames] as Hashtable;
        ...
        internal static Activity ParseActivityForBind(Activity context, string activityName)
        {
            ...
            if (activity2 == null)
            {
                if (!declaringActivity.UserData.Contains(UserDataKeys.CustomActivityDefaultName))
                {
                    ...
                    declaringActivity.UserData[UserDataKeys.CustomActivityDefaultName] = activity6.Name;
                }
        ...
        internal static void SetDesignTimeTypeName(object owner, object key, string value)
        {
            ...
            {
                if (!obj2.UserData.Contains(UserDataKeys.DesignTimeTypeNames))
                {
                    obj2.UserData[UserDataKeys.DesignTimeTypeNames] = new Hashtable();
                }
                Hashtable hashtable = obj2.UserData[UserDataKeys.DesignTimeTypeNames] as Hashtable;
                hashtable[key] = value;
            }
