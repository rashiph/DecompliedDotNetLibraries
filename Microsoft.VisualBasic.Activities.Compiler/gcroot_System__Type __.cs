...
internal struct gcroot<System::Type ^>
{
    public static unsafe void <MarshalCopy>(gcroot<System::Type ^>* e ^>Ptr2, gcroot<System::Type ^>* e ^>Ptr1)
    {
    ...
    public static unsafe void <MarshalDestroy>(gcroot<System::Type ^>* e ^>Ptr1)
    {
        IntPtr ptr = new IntPtr(*((void**) e ^>Ptr1));
        ((GCHandle) ptr).Free();
        *((int*) e ^>Ptr1) = 0;
