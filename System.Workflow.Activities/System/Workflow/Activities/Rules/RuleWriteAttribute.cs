namespace System.Workflow.Activities.Rules
{
    ...
    {
        public RuleWriteAttribute(string path) : base(path, RuleAttributeTarget.This)
        {
        }

        [TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
        public RuleWriteAttribute(string path, RuleAttributeTarget target) : base(path, target)
        {
        }
